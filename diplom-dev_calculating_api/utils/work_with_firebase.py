...
# from config import frebase_creds_folder
# from firebase_admin import auth
# import traceback


# pb = pyrebase.initialize_app(json.load(open(os.path.join(irebase_creds_folder, 'fbconfig.json'))))

# with open(os.path.join(irebase_creds_folder, 'fbconfig.json')) as f:
#     d = json.load(f)
